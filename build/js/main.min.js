...
function dropLevel1(){let o=document.getElementById("dropdownContent"),e=document.querySelector(".dropdown__icon");o.classList.toggle("show"),e.classList.toggle("show-ico")}
