...
const isMobile={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return isMobile.Android()||isMobile.BlackBerry()||isMobile.iOS()||isMobile.Opera()||isMobile.Windows()}};if(isMobile.any()){document.body.classList.add("_touch");let e=document.querySelectorAll(".menu__arrow");if(e.length>0)for(let n=0;n<e.length;n++){const i=e[n];i.addEventListener("click",(function(e){i.parentElement.classList.toggle("_active")}))}}else document.body.classList.add("_pc");const iconMenu=document.querySelector(".menu__icon"),menuBody=document.querySelector(".menu__body");iconMenu&&iconMenu.addEventListener("click",(function(e){document.body.classList.toggle("_lock"),iconMenu.classList.toggle("_active"),menuBody.classList.toggle("_active")}));
function dropDownCategories(){let o=document.getElementById("catalog-dropdown__content"),t=document.querySelector(".catalog-dropdown__icon");o.classList.toggle("_show"),t.classList.toggle("_show-ico")}window.addEventListener("click",(function(o){var t=document.getElementById("navigation__catalog-dropdown"),e=o.target.compareDocumentPosition(t);if(!o.target.matches(".catalog-dropdown__btn")&&10!==e){var n=document.getElementsByClassName("catalog-dropdown__content");for(let o=0;o<n.length;o++){(s=n[o]).classList.contains("_show")&&s.classList.remove("_show")}var a=document.getElementsByClassName("catalog-dropdown__icon");for(let o=0;o<a.length;o++){var s;(s=a[o]).classList.contains("_show-ico")&&s.classList.remove("_show-ico")}}}));
function mobileScrollLockOn(){window.innerWidth<=425&&(document.body.style.overflow="hidden")}function mobileScrollLockOff(){window.innerWidth<=425&&document.body.removeAttribute("style")}function searchContentShow(){document.getElementById("navigation__search-content").classList.add("_show"),mobileScrollLockOn()}function searchContentHide(){setTimeout((function(){document.getElementById("navigation__search-content").classList.remove("_show")}),200)}function searchContentClose(t){var e=document.getElementById("navigation__search-content"),n=t.target.compareDocumentPosition(e),i=t.target.matches("#navigation__search-input"),o=t.target.matches(".header__search"),s=t.target.matches(".search-icon"),c=t.target.matches(".green-button");i||o||s||c||10===n||e.classList.contains("_show")&&(e.classList.remove("_show"),document.body.removeAttribute("style"))}function getCoords(t){let e=t.getBoundingClientRect();return{top:e.top+pageYOffset,left:e.left+pageXOffset,width:e.width,height:e.height}}class SearchContent{constructor(){this.windowInnerWidth=window.innerWidth,this.searchContent=document.getElementById("navigation__search-content"),this.search=document.getElementById("navigation__search")}positioning(){var t=getCoords(this.search);if(this.windowInnerWidth>425)return this.searchContent.style.left=t.left+"px",void(this.searchContent.style.top=t.top+t.height+4+"px");this.searchContent.removeAttribute("style")}resizing(){if(this.windowInnerWidth>425&&this.windowInnerWidth<=1024){let t=document.getElementById("navigation").clientWidth,e=document.getElementById("navigation__catalog-dropdown").clientWidth;this.searchContent.style.width=t-e-80-35+"px"}else if(this.windowInnerWidth>1024){let t=this.search.clientWidth;this.searchContent.style.width=t+2+"px"}else this.searchContent.removeAttribute("style")}}document.addEventListener("DOMContentLoaded",(function(){let t=new SearchContent;t.positioning(),t.resizing()})),window.addEventListener("resize",(function(){let t=new SearchContent;t.positioning(),t.resizing()})),window.addEventListener("click",(function(t){searchContentClose(t)}));
