...
function dropDownCategories(){let o=document.getElementById("catalog-dropdown__content"),t=document.querySelector(".catalog-dropdown__icon");o.classList.toggle("show"),t.classList.toggle("show-ico")}window.onclick=function(o){if(!o.target.matches(".catalog-dropdown__btn")&&!o.target.matches(".catalog-dropdown__icon")){var t=document.getElementsByClassName("catalog-dropdown__content");for(e=0;e<t.length;e++){(n=t[e]).classList.contains("show")&&n.classList.remove("show")}var e,s=document.getElementsByClassName("catalog-dropdown__icon");for(e=0;e<s.length;e++){var n;(n=s[e]).classList.contains("show-ico")&&n.classList.remove("show-ico")}}};
