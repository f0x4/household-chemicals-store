...
const isMobile={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return isMobile.Android()||isMobile.BlackBerry()||isMobile.iOS()||isMobile.Opera()||isMobile.Windows()}};if(isMobile.any()){document.body.classList.add("_touch");let e=document.querySelectorAll(".menu__arrow");if(e.length>0)for(let n=0;n<e.length;n++){const t=e[n];t.addEventListener("click",(function(e){t.parentElement.classList.toggle("_active")}))}}else document.body.classList.add("_pc");const iconMenu=document.querySelector(".menu__icon"),menuBody=document.querySelector(".menu__body");iconMenu&&iconMenu.addEventListener("click",(function(e){if(iconMenu.classList.contains("_active")){return document.getElementById("navigation__search-content").classList.remove("_show"),document.body.removeAttribute("style"),document.getElementById("header__search").classList.remove("_open"),document.getElementById("header__logo").style.display="block",document.body.classList.remove("_lock"),iconMenu.classList.remove("_active"),void menuBody.classList.remove("_active")}document.body.classList.add("_lock"),iconMenu.classList.add("_active"),menuBody.classList.add("_active")}));
...
function mobileScrollLockOn(){window.innerWidth<=425&&(document.body.style.overflow="hidden")}function mobileScrollLockOff(){window.innerWidth<=425&&document.body.removeAttribute("style")}function searchContentShow(){document.getElementById("navigation__search-content").classList.add("_show"),mobileScrollLockOn(),document.querySelector(".menu__icon").classList.add("_active"),document.getElementById("header__search").classList.add("_open"),document.getElementById("header__logo").style.display="none"}function searchContentHide(){setTimeout((function(){document.getElementById("navigation__search-content").classList.remove("_show")}),200)}function searchContentClose(e){var t=document.getElementById("navigation__search-content"),n=e.target.compareDocumentPosition(t),o=e.target.matches("#navigation__search-input"),i=e.target.matches(".header__search"),s=e.target.matches(".search-icon"),c=e.target.matches(".green-button");if(!(o||i||s||c||10===n)&&t.classList.contains("_show")){t.classList.remove("_show"),document.body.removeAttribute("style"),document.querySelector(".menu__icon").classList.remove("_active"),document.getElementById("header__search").classList.remove("_open"),document.getElementById("header__logo").style.display="block"}}function getCoords(e){let t=e.getBoundingClientRect();return{top:t.top+pageYOffset,left:t.left+pageXOffset,width:t.width,height:t.height}}class SearchContent{constructor(){this.windowInnerWidth=window.innerWidth,this.searchContent=document.getElementById("navigation__search-content"),this.search=document.getElementById("navigation__search")}positioning(){var e=getCoords(this.search);if(this.windowInnerWidth>425)return this.searchContent.style.left=e.left+"px",void(this.searchContent.style.top=e.top+e.height+4+"px");this.searchContent.removeAttribute("style")}resizing(){if(this.windowInnerWidth>425&&this.windowInnerWidth<=1024){let e=document.getElementById("navigation").clientWidth,t=document.getElementById("navigation__catalog-dropdown").clientWidth;this.searchContent.style.width=e-t-80-35+"px"}else if(this.windowInnerWidth>1024){let e=this.search.clientWidth;this.searchContent.style.width=e+2+"px"}else this.searchContent.removeAttribute("style")}}document.addEventListener("DOMContentLoaded",(function(){let e=new SearchContent;e.positioning(),e.resizing()})),window.addEventListener("resize",(function(){let e=new SearchContent;e.positioning(),e.resizing()})),window.addEventListener("click",(function(e){searchContentClose(e)}));
