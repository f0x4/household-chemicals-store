...
$(document).ready((function(){var t=window.location.href.substr(window.location.href.lastIndexOf("/")+1);$(".tapbar__item").each((function(){$(this).attr("href")!=t&&""!=$(this).attr("href")||$(this).addClass("active")}))}));
!function(){var e=function(e){var o;this.element=e,this.elementId=this.element.getAttribute("id"),this.trigger=document.querySelectorAll('[aria-controls="'+this.elementId+'"]'),this.selectedTrigger=!1,this.popoverVisibleClass="popover--is-visible",this.selectedTriggerClass="popover-control--active",this.popoverIsOpen=!1,this.firstFocusable=!1,this.lastFocusable=!1,this.positionTarget=!!(o=this.element.getAttribute("data-position-target"))&&document.querySelector(o),this.viewportGap=parseInt(getComputedStyle(this.element).getPropertyValue("--popover-viewport-gap"))||20,function(e){for(var t=0;t<e.trigger.length;t++)Util.setAttributes(e.trigger[t],{"aria-expanded":"false","aria-haspopup":"true"})}(this),function(e){for(var o=0;o<e.trigger.length;o++)!function(o){e.trigger[o].addEventListener("click",(function(i){i.preventDefault(),Util.hasClass(e.element,e.popoverVisibleClass)&&e.selectedTrigger!=e.trigger[o]&&t(e,!1,!1),e.selectedTrigger=e.trigger[o],t(e,!Util.hasClass(e.element,e.popoverVisibleClass),!0)}))}(o);e.element.addEventListener("keydown",(function(t){(t.keyCode&&9==t.keyCode||t.key&&"Tab"==t.key)&&function(e,t){e.firstFocusable==document.activeElement&&t.shiftKey&&(t.preventDefault(),e.lastFocusable.focus());e.lastFocusable!=document.activeElement||t.shiftKey||(t.preventDefault(),e.firstFocusable.focus())}(e,t)}))}(this)};function t(e,t,n){Util.toggleClass(e.element,e.popoverVisibleClass,t),e.popoverIsOpen=t,t?(e.selectedTrigger.setAttribute("aria-expanded","true"),function(e){var t=e.element.querySelectorAll(r);(function(e,t){for(var o=0;o<t.length;o++)if(i(t[o])){e.firstFocusable=t[o];break}})(e,t),function(e,t){for(var o=t.length-1;o>=0;o--)if(i(t[o])){e.lastFocusable=t[o];break}}(e,t)}(e),o(e),e.element.addEventListener("transitionend",(function(t){o(e)}),{once:!0}),function(e){!function(e){e.element.style.maxHeight="",e.element.style.top="",e.element.style.bottom="",e.element.style.left="",e.element.style.right=""}(e);var t=e.positionTarget?e.positionTarget.getBoundingClientRect():e.selectedTrigger.getBoundingClientRect(),o=window.innerHeight-t.bottom<t.top,i=t.left,n=window.innerWidth-t.right,r=window.innerWidth<t.left+e.element.offsetWidth,s=r?"right: "+n+"px;":"left: "+i+"px;",l=o?"bottom: "+(window.innerHeight-t.top)+"px;":"top: "+t.bottom+"px;";r&&n+e.element.offsetWidth>window.innerWidth&&(s="left: "+parseInt((window.innerWidth-e.element.offsetWidth)/2)+"px;");var a=o?t.top-e.viewportGap:window.innerHeight-t.bottom-e.viewportGap,c=e.element.getAttribute("style");c||(c="");e.element.setAttribute("style",c+s+l+"max-height:"+Math.floor(a)+"px;")}(e),Util.addClass(e.selectedTrigger,e.selectedTriggerClass)):e.selectedTrigger&&(e.selectedTrigger.setAttribute("aria-expanded","false"),n&&Util.moveFocus(e.selectedTrigger),Util.removeClass(e.selectedTrigger,e.selectedTriggerClass),e.selectedTrigger=!1)}function o(e){e.firstFocusable?e.firstFocusable.focus():Util.moveFocus(e.element)}function i(e){return e.offsetWidth||e.offsetHeight||e.getClientRects().length}e.prototype.togglePopover=function(e,o){t(this,e,o)},e.prototype.checkPopoverClick=function(e){!function(e,o){if(!e.popoverIsOpen)return;e.element.contains(o)||o.closest('[aria-controls="'+e.elementId+'"]')||t(e,!1)}(this,e)},e.prototype.checkPopoverFocus=function(){!function(e){if(!e.popoverIsOpen)return;var o=document.activeElement.closest(".js-popover");t(e,!1,o)}(this)},window.Popover=e;var n=document.getElementsByClassName("js-popover"),r='[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex]:not([tabindex="-1"]), [contenteditable], audio[controls], video[controls], summary';if(n.length>0){for(var s=[],l=[],a=0;a<n.length;a++)!function(t){s.push(new e(n[t]));var o=n[t].getAttribute("data-scrollable-element");o&&!l.includes(o)&&l.push(o)}(a);window.addEventListener("keyup",(function(e){(e.keyCode&&27==e.keyCode||e.key&&"escape"==e.key.toLowerCase())&&s.forEach((function(e){e.checkPopoverFocus()}))})),window.addEventListener("click",(function(e){s.forEach((function(t){t.checkPopoverClick(e.target)}))})),window.addEventListener("resize",(function(e){s.forEach((function(e){e.togglePopover(!1,!1)}))})),window.addEventListener("scroll",(function(e){s.forEach((function(e){e.popoverIsOpen&&e.togglePopover(!1,!1)}))}));for(var c=0;c<l.length;c++){var d=document.querySelector(l[c]);d&&d.addEventListener("scroll",(function(e){s.forEach((function(e){e.popoverIsOpen&&e.togglePopover(!1,!1)}))}))}}}();
